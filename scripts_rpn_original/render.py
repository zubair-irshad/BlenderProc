...
def main():
    ...
    if args.mode == "overview":
        ...
        save_in_ngp_format(
            None, poses, K, room_bbox, room_objs_dict, dst_dir
        )  # late rendering
        ...
        data_folder = "/wild6d_data/zubair/nerf_rpn/front3d_rpn_data/features"
        data_path = os.path.join(
            data_folder, f"3dfront_{args.scene_idx:04d}_{args.room_idx:02d}.npz"
        )
